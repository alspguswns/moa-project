        ...
        <div style={{
            ...
            {deleteModal && (
                <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.4)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
                    <div style={{ background: "white", borderRadius: "20px", padding: "28px", width: "320px", textAlign: "center", border: "1px solid #ffd9e2" }}>
                        <span style={{ fontSize: "36px", display: "block", marginBottom: "12px" }}>🐷</span>
                        <p style={{ margin: "0 0 8px", fontSize: "15px", fontWeight: "700", color: "#333" }}>정말로 탈퇴할까요?</p>
                        <p style={{ margin: "0 0 20px", fontSize: "13px", color: "#aaa" }}>모든 데이터가 삭제되고 복구할 수 없어요.</p>
            ...
            <div style={{ marginLeft: "72px", marginTop: "64px", width: "calc(100vw - 72px)", height: "calc(100vh - 64px)", padding: "32px", boxSizing: "border-box", overflowY: "auto" }}>
                <div style={{ maxWidth: "720px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "20px" }}>
                    ...
                    {/* 프로필 정보 카드 */}
                    <section style={{ background: "white", borderRadius: "24px", padding: "28px", border: "1px solid #f0f0f0", boxShadow: "0 4px 16px rgba(0,0,0,0.04)" }}>
                        <p style={{ margin: "0 0 20px", fontSize: "15px", fontWeight: "700", color: "#111" }}>기본 정보</p>

                        {/* 프로필 사진 */}
                        <div style={{ display: "flex", alignItems: "center", gap: "20px", marginBottom: "20px" }}>
                            <div style={{ width: "80px", height: "80px", borderRadius: "50%", background: "#fff0f3", border: "3px solid #F4A7B9", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "40px", overflow: "hidden", flexShrink: 0 }}>
                        ...
                        <div style={{ marginBottom: "14px" }}>
                            <label style={{ fontSize: "12px", color: "#888", display: "block", marginBottom: "6px" }}>닉네임</label>
                            <input value={nickname} onChange={e => setNickname(e.target.value)} placeholder="닉네임을 입력해줘요" style={inputStyle} />
                        </div>

                        {/* 한 줄 소개 */}
                        <div style={{ marginBottom: "20px" }}>
                            <label style={{ fontSize: "12px", color: "#888", display: "block", marginBottom: "6px" }}>한 줄 목표</label>
                            <input value={bio} onChange={e => setBio(e.target.value)} placeholder="예: 이번 달 10만원 절약하기!" style={inputStyle} />
                        </div>

                        <button onClick={handleSaveProfile} style={{ padding: "12px 28px", background: saved ? "#aaa" : "#F4A7B9", color: "white", border: "none", borderRadius: "12px", fontSize: "14px", fontWeight: "700", cursor: "pointer" }}>
                            {saved ? "저장됐어요 ✓" : "저장하기"}
                        </button>
                    </section>
                    ...
                    {/* 비밀번호 변경 카드 */}
                    <section style={{ background: "white", borderRadius: "24px", padding: "28px", border: "1px solid #f0f0f0", boxShadow: "0 4px 16px rgba(0,0,0,0.04)" }}>
                        <p style={{ margin: "0 0 20px", fontSize: "15px", fontWeight: "700", color: "#111" }}>비밀번호 변경</p>

                        <div style={{ marginBottom: "12px" }}>
                            <label style={{ fontSize: "12px", color: "#888", display: "block", marginBottom: "6px" }}>현재 비밀번호</label>
                            <input type="password" value={currentPw} onChange={e => setCurrentPw(e.target.value)} placeholder="현재 비밀번호" style={inputStyle} />
                        </div>
                        <div style={{ marginBottom: "12px" }}>
                            <label style={{ fontSize: "12px", color: "#888", display: "block", marginBottom: "6px" }}>새 비밀번호</label>
                            <input type="password" value={newPw} onChange={e => setNewPw(e.target.value)} placeholder="새 비밀번호" style={inputStyle} />
                        </div>
                        <div style={{ marginBottom: "16px" }}>
                            <label style={{ fontSize: "12px", color: "#888", display: "block", marginBottom: "6px" }}>새 비밀번호 확인</label>
                    ...
                    {/* 계정 관리 카드 */}
                    <section style={{ background: "white", borderRadius: "24px", padding: "28px", border: "1px solid #f0f0f0", boxShadow: "0 4px 16px rgba(0,0,0,0.04)" }}>
                        <p style={{ margin: "0 0 20px", fontSize: "15px", fontWeight: "700", color: "#111" }}>계정 관리</p>
                        <div style={{ display: "flex", gap: "12px" }}>
                            <button onClick={onLogout} style={{ padding: "12px 28px", background: "#f5f5f5", color: "#555", border: "none", borderRadius: "12px", fontSize: "14px", fontWeight: "700", cursor: "pointer" }}>
                                🚪 로그아웃
                            </button>
